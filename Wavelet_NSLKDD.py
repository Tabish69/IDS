...
X_train, y_train, encoder = preprocess_data("C:\\Users\\tabis\\OneDrive\\Desktop\\BTP_5\\KDDTrain+.txt",
                                            fit_encoder=True)

# Load and preprocess test data using the fitted encoder
X_test, y_test, _ = preprocess_data("C:\\Users\\tabis\\OneDrive\\Desktop\\BTP_5\\KDDTest+.txt", encoder=encoder,
                                    fit_encoder=False)
